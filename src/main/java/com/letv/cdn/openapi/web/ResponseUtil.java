...
public class ResponseUtil {
    ...
    public static void sendJsonNoCache(HttpServletResponse response, JsonResult jsonResult) throws IOException {
        sendJsonNoCache(response, jsonResult.toString());
    }



    public static void sendJsonpNoCache(HttpServletResponse response, String callback, JsonResult jsonResult) throws IOException {
        sendJsonpNoCache(response, callback, jsonResult.toString());
    }
    ...
    public static void sendMessageNoCache(HttpServletRequest req, HttpServletResponse response, String message) throws IOException {
        ...
        }    else if(fmt.equals("redirect")) {
            String redirect = RequestUtils.getRedirect(req);
            response.sendRedirect(ResponseUtil.addParam(redirect,"msg="+ XXTEA.encrypt(message, "letv")));
        }
    }
